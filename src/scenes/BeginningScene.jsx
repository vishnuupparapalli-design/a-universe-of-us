 ...
 * Ancient Celestial Shrine, Cosmic Shockwave, and Star Birth
 */
export default function BeginningScene({ onMerged }) {
  ...
  const handleBeginMeeting = () => {
    ...
    gsap.to(lightBRef.current.position, {
      ...
      onComplete: () => {
        ...
        // 3. Cinematic Camera Pull-Back into the Starlight Universe
  ...
  return (
    <group ref={groupRef} position={[0, -0.15, 0]}>
      ...
      {/* Cosmic Shockwave Ring (expands on collision) */}
      ...
      {/* Lower Shard Base (Ancient Weathered Slate) */}
      ...
      {/* ================= THE TWO LIGHTS (PRE-MERGE) ================= */}
      {!hasMerged && (
        <group onClick={handleBeginMeeting} className="cursor-pointer">
          {/* Light A: Violet-Blue Mote (Her Light) */}
          ...
          {/* Light B: Warm Gold Mote (Your Light) */}
